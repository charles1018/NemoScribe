...
def main():
    ...
    parser.add_argument(
        '--test-dir',
        type=Path,
        default=Path(r'C:\Users\charles\Videos\Captures\param_test'),
        help='Directory containing test SRT files'
    )
    parser.add_argument(
        '--reference',
        type=Path,
        default=Path(r'C:\Users\charles\Videos\Captures\Chicago.Fire.S12E01.1080p.WEB.h264-ETHEL.ENG.srt'),
